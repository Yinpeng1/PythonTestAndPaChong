...
def send_http_post(image_path):
    chaojiying = Chaojiying_Client('yinpeng123456', 'yinpeng0927', '899187')  # 用户中心>>软件ID 生成一个替换 96001
...
#     print(result)
#     # result = json.loads(chaojiying.PostPic(im, 1902))
